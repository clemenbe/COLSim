...
class Whale(SeaObject):
    ...
    def __init__(self, mmsi, x, y, v, theta,  algo, destination_distance=20):
        ...
        self.privilege = 500
        self.r = 2
        print("Whale created:  mmsi %s, in position (%s, %s), speed v= %s, theta= %s, with the algorithm: %s" % (mmsi, x, y, v, theta, algo))



    #here, how a whale moves
    ...
    def draw(self, ax, Ɛ, col='blue', coef=0.1, w=2):
        ...
        draw_disk(ax, self.phat, 1, 'orange')                                   # Display of the final destination
