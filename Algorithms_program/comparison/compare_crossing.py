...
def compare_traj():
    """Show the results of the simulation (trajectories) with different algorithms for a face to face crossing.
    """
    ...
    L=["Algorithms_program/comparison/data/simulation_log20240705-103556.csv",
       "Algorithms_program/comparison/data/simulation_log20240724-170710.csv",   #old: 11-134509
       "Algorithms_program/comparison/data/simulation_log20240711-121528.csv",
       "Algorithms_program/comparison/data/simulation_log20240726-153407.csv",        #old: 24-115453
       "Algorithms_program/comparison/data/simulation_log20240705-110032.csv"]
...
def compare_traj2():
    ...
    L=["Algorithms_program/comparison/data/simulation_log20240711-134509.csv",
       ...
       "Algorithms_program/comparison/data/simulation_log20240711-121528.csv",
       "Algorithms_program/comparison/data/simulation_log20240711-121233.csv"]
...
def compare_matrices():
    ...
    L=["Algorithms_program/comparison/data/simulation_log20240705-103556.csv",
       "Algorithms_program/comparison/data/simulation_log20240726-153708.csv",    #old 19-153419
       "Algorithms_program/comparison/data/simulation_log20240719-153438.csv",
       "Algorithms_program/comparison/data/simulation_log20240726-154207.csv",    #old: 19-153521
       "Algorithms_program/comparison/data/simulation_log20240724-170710.csv",    #old: 11-134509
       "Algorithms_program/comparison/data/simulation_log20240726-154611.csv",        #old: 19-153548
       "Algorithms_program/comparison/data/simulation_log20240719-153616.csv",
       "Algorithms_program/comparison/data/simulation_log20240726-154714.csv",      #old :19-153642
       "Algorithms_program/comparison/data/simulation_log20240705-110032.csv"]
